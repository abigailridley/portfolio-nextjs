  ...
  return (
    ...
    transition={{ delay: 0.175 }}>
      ...
      <SectionWindow title='Summary' className="relative">
        ...
        <p>
                        To be a <span className="font-bold">full-stack developer</span> is my ultimate goal, which drives me to explore a vast array of programming languages and tools. Courses in <span className="font-bold">Front-end development and React</span> led me to enroll in an <span className="font-bold">intensive Python course</span>, immersing myself in <span className="font-bold">back-end development</span> and testing out my <span className="font-bold">Scrum master</span> skills. Earning a distinction was a moment of pride that fueled me even more.
                    </p>
                    <p>
