  ...
  return (
    ...
    >
      ...
      >
        <div className="mb-5 mt-4 px-4 text-2xl leading-4 text-center sm:text-4xl">
          <h1 className="font-chango">
            Hi, I&apos;m Abigail
            <p className="font-plexmono italic text-xl sm:text-3xl">
              Software Developer
            </p>
          </h1>
        </div>
        ...
        <div className="text-md sm:text-xl !leading-5 pb-10">
          <p>I build sites & apps.</p>
          <p>
            My focus is <span className="font-bold">React & Next.js</span> with
            a side of <span className="font-bold">Python.</span>{" "}
          </p>
        </div>
      </motion.div>
      ...
      >
        <Link
          href="#contact"
          className="group bg-orange text-black px-7 py-3 flex items-center gap-2 rounded-lg  focus-visible:scale-110 hover:scale-110  focus-visible:outline-none focus-visible:ring focus-visible:ring-offset-2 hover:bg-[#f47b56] active:scale-105 transition dark:bg-primary-blue/60 dark:text-white/90 dark:hover:bg-primary-blue/80"
          onClick={() => {
        ...
        <a
          className="bg-white text-gray-700 p-4 flex items-center gap-2 rounded-lg focus-visible:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:scale-110 hover:scale-[1.15]  hover:text-gray-950 active:scale-[1.15] transition cursor-pointer border-black/10 dark:bg-white/10 dark:text-white/80"
          href="https://linkedin.com/in/ar-ridley"
          target="_blank"
        >
          <BsLinkedin aria-label="linkedin" />
        </a>
        <a
          className="bg-white text-gray-700 p-4 flex items-center gap-2 rounded-lg text-[1.35rem] focus-visible:outline-none focus-visible:ring focus-visible:ring-offset-2 focus-visible:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer border-black/10 dark:bg-white/10 dark:text-white/90"
          href="https://github.com/abigailridley"
          target="_blank"
        >
